          ...
          <?php include('pages_setting.php'); ?>   
            <div class="card-header" style="background-color: rgb(255 236 230);">
                <div class="d-flex justify-content-between align-items-center">
                    <div class="header">Manage Type</div>

                     <div> 

                        <button type="button" class="btn btn-primary" id="ViewDiv" onclick="ShowHideDiv(this.value);" value="view">Add Type</button>

                        <button type="button" class="btn btn-primary" id="AddDiv" onclick="ShowHideDiv(this.value);" value="add">View Type</button>
 ...
 <script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $('#myTable').DataTable({
                    ...
                    'ajax': {
                        ...
                        'data': {
                            'action': 'loadvehicletypetabledata'
                        }
                    },
                    'columns': [
                        { data: 'name' },
        ...
        $("#TypeForm").validate({
            ...
            messages: {
                name: "Please enter your type name",
            },
            submitHandler: function(form) {
                ...
                $.ajax({
                    ...
                    type: "POST", 
                    dataType:"JSON",            
                    data: $("#TypeForm").serialize()+"&action=VehicleTypeform",
                    cache: false,             
                    processData: false,      
    ...
    function edit(id)
    {
        ...
        $.ajax({
            ...
            data: {action : 'VehicleTypeUpdateData', id: id},
    ...
    function deleterow(id)
    {
        ...
        $.ajax({
            ...
            data: {action : 'VehicleTypeDeleteData', id: id},

                                ...
                                <div class='widget-main padding-24'>
                                    ...
                                    <table class='table table-responsive table'>
                                        ...
                                        <tbody>
                                            ...
                                            $mysql->dbConnect();
                                            $vatFlag = 0;
                                            $tblquery = "SELECT ci.`id`,ci.`week_no`,ci.`invoice_no`,ct.`rateid`,ct.`date`,ct.`value`,
                                            ct.`ischeckval`,ci.`vat` as civat,p.`name`,p.`type`,p.`amount`,p.`vat`,ci.`from_date`,ci.`to_date`,u.`vat_number` as vat_number1 
                                            ...
                                            ?>
                                                    ...
                                                    ?>
                                                    <tr>
                                                        <td><?php echo $tblresult['name'] . ' - <strong>' . $adddate . "</strong> " . $route; ?></td>
                                    ...
                                    <div class='row'>
                                        ...
                                        <div class='col-sm-5 pull-right' style="text-align: right;">
                                            ...
                                            if ($paidamount > 0) {
                                            ?>
                                                <span>£<?php echo $tresult['totalamount']; ?> deposit will be deducted in <?php echo $tresult['no_of_instal']; ?> instalments of £<?php echo $singleamount; ?>/per week until full deposit is recovered : -£ <?php echo $tresult['amount']; ?></span>
                                            <?php
                                            }
                                            ?>

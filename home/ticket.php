                                ...
                                <div class="card-body">
                                    <div class="d-flex flex-row">
                                        <div class="m-l-10 align-self-center text-center">
                                            ...
                                            ?>
                                            <div class="ticketshow" onclick="loadtable('total');">
                                                <h3 class="m-b-0 text-xl"><?php echo $fetch['total']; ?></h3>
                                            </div>
                                ...
                                <div class="card-body">
                                    <div class="d-flex flex-row">
                                        <div class="m-l-10 align-self-center text-center">
                                            ...
                                            $fetch = mysqli_fetch_array($exrow);
                                            ?>
                                            <div class="ticketshow" onclick="ticketshow('1');">
                                                <h3 class="m-b-0 text-xl"><?php echo $fetch['statustotal']; ?></h3>
                                            </div>
                                            <h5 class="m-b-0 text-center text-xl">Process</h5>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card-body">
                                    <div class="d-flex flex-row">
                                        <div class="m-l-10 align-self-center text-center">
                                            ...
                                            $fetch = mysqli_fetch_array($exrow);
                                            ?>
                                            <div class="ticketshow" onclick="ticketshow('2');">
                                                <h3 class="m-b-0 text-xl " id="escolet"><?php echo $fetch['escolet']; ?></h3>
                                            </div>
                                            <h5 class="m-b-0 text-center text-xl">ESCALATE</h5>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card-body">
                                    <div class="d-flex flex-row">
                                        <div class="m-l-10 align-self-center text-center">
                                            ...
                                            $fetch = mysqli_fetch_array($exrow);
                                            ?>
                                            <div class="ticketshow" onclick="ticketshow('3');">
                                                <h3 class="m-b-0 text-xl " id="closetotal"><?php echo $fetch['closetotal']; ?></h3>
                                            </div>
                                            <h5 class="m-b-0 text-center text-xl">Close</h5>
                                        </div>
                                    </div>
                                </div>
                            </div>

          ...
          <?php include('pages_setting.php'); ?>   
            <div class="card-header" style="background-color: rgb(255 236 230);">
                <div class="d-flex justify-content-between align-items-center">
                    <div class="header">Manage Status</div>
 ...
 <script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $('#myTable').DataTable({
                    ...
                    'ajax': {
                        ...
                        'data': {
                            'action': 'loadvehiclestatustabledata'
                        }
                    },
                    'columns': [
                        { data: 'name' },
    ...
    function edit(id)
    {
        ...
        $.ajax({
            ...
            data: {action : 'VehicleStatusUpdateData', id: id},
            ...
            success: function(data) {
                ...
                $('#colorcode').val($result_data['colorcode']);
    ...
    function deleterow(id)
    {
        ...
        $.ajax({
            ...
            data: {action : 'VehicleStatusDeleteData', id: id},

                 ...
                 <div class="card">    
                    ...
                    <div class="card-body" id="ViewFormDiv">
                        <div class="row">
                            ...
                            <input type="button" class="btn btn-info col-md-12" value='Export' onclick="loadExporterTable();">
                              </div>

                         </div><hr><br>
                            <div class="table-responsive" id="allInvoicesSection">       
                  ...
                  <div class="col-md-12" id="exportInvoicesSection" style="display:none;">
                    <div class="card">
                      <div class="card-header" style="background-color: rgb(255 236 230);">
                        <div class="d-flex justify-content-between align-items-center">
                          <div class="header">Vehicles Exporter</div>
 ...
 <script type="text/javascript">
    ...
    // });
     ...
     function loadExporterTable() {
        ...
        $.ajax({
          type: "POST",
          url: "ExportvehicleDatatable.php",
          data: {
            action: 'exportVehicleTableData',

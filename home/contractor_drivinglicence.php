                ...
                <div class="card">    
                     <div class="card-header" style="background-color: rgb(255 236 230);">
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="header">Contactor / <?php echo $cntresult['name'];?></div>
                            <div> 
                              <a href="">
  ...
  <div class="row">
    <div class="card col-md-12" style="border: 1px solid #d1d5db;">   
      ...
      <div class="card-body" id="AddFormDiv">
          <div class="row">
            <div class="col-md-12">
                <form method="post" id="ContractoreDrivinglicenceForm" name="ContractoreDrivinglicenceForm" action="">
...
$("#ContractoreDrivinglicenceForm").validate({
rules: {
...
submitHandler: function(form) {
  ...
  $.ajax({
    ...
    type: "POST", 
    dataType:"JSON",            
    data: $("#ContractoreDrivinglicenceForm").serialize()+"&action=ContractoreDrivinglicenceForm",
    success: function(data) {
        if(data.status==1)
        {
             myAlert(data.title + "@#@" + data.message + "@#@success");
             $('#ContractoreDrivinglicenceForm')[0].reset();
                // if(data.name == 'Update')
                // {

...
include 'DB/config.php';
  $page_title = "Workforce Payment Arrears";
   $page_id=37;
    if(!isset($_SESSION)) 
    {
        session_start();
  ...
  <div class="row">
    <div class="card col-md-12" style="border: 1px solid #d1d5db;">   
      ...
      <div class="card-body" id="AddFormDiv">
          <div class="row">
            <div class="col-md-12">
                <form method="post" id="WorkforcePaymentArreasForm" name="WorkforcePaymentArreasForm" action="">
...
$(document).ready(function(){
  ...
  $("#WorkforcePaymentArreasForm").validate({
    rules: {
        arrears: 'required',
    },
    messages: {
    ...
    submitHandler: function(form) {
      ...
      $.ajax({
        ...
        type: "POST", 
        dataType:"JSON",            
        data: $("#WorkforcePaymentArreasForm").serialize()+"&action=WorkforcePaymentArreasForm",
        success: function(data) {
            if(data.status==1)
            {

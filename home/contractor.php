 ...
 <script type="text/javascript">
       ...
       $('input:radio[name="type"]').change(
        ...
        $("#company").change(function () {
            ...
            $.ajax({
                type: "POST",
                url: "loaddata.php",
                data: {action : 'Companydata', companyid: companyid},
                dataType: 'json',
    ...
    function loadpage(id)
    {
        $.ajax({
            type: "POST",
            url: "loaddata.php",
            data: {action : 'ContractorSetSessionData', cid: id},
            dataType: 'json',
            success: function(data) {
                if(data.status==1)
                {
    ...
    function resendurl(cid)
    {
    	$.ajax({
            ...
            type: "POST", 
            dataType:"JSON",            
            data: {action : 'ContractorURLSend', cid: cid},      
            success: function(data) {
                if(data.status==1)
                {
                    myAlert(data.title + "@#@" + data.message + "@#@success");
    ...
    function resendonboardurl(cid)
    {
      $.ajax({
            ...
            type: "POST", 
            dataType:"JSON",            
            data: {action : 'ContractorOnboardURLSend', cid: cid},      
            success: function(data) {
                if(data.status==1)
                {
                    myAlert(data.title + "@#@" + data.message + "@#@success");
          ...
          swal({ 
                ...
                if(result.value)
                {
                   $.ajax({
                      type: "POST",
                      url: "loaddata.php",
                      data: {action : 'ContractorDeleteData', id: id},
                      dataType: 'json',
                      success: function(data) {
                          if(data.status==1)
                          {

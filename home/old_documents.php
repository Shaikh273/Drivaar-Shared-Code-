                                                             ...
                                                             <div class="col-md-12">
                                                                <form action="" method="post">
                                                                    ...
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-md-8">
                                                                            <input type="file" name="documents" id="documents" value="" class="form-control">
                                                                        </div>
                                                                    </div>
                                                                    <hr>
                                                                     <div class="card-footer">
                                                                        <button class="btn btn-primary " data-aire-component="button" type="submit" name="addmetric">Upload
                                                                        </button>
                                                                    </div>
                                                                </form>
                                                            </div>

                  ...
                  <form method="post" id="DocumentForm" name="DocumentForm" action="" enctype="multipart/form-data">
                      ...
                      <input type="hidden" name="cid" id="cid" value="<?php echo $id?>">  
                         <div class="form-body">
                                ...
                                <div class="col-md-6">
                                      <div class="form-group">
                                          ...
                                          <select class="select form-control custom-select" id="type" name="type">
                                            ...
                                            {
                                              ?>
                                                  <option value="<?php echo $statusresult['id']?>" data-ise='<?php echo $statusresult['isexpiry_date']?>'><?php echo $statusresult['name']?></option>
                                              <?php
                                            }
                                            $mysql -> dbDisconnect();
                                            ?>
                            ...
                            <div class="row">
                                <div class="col-md-6 hidden" id="isexpDiv">
...
?>
 <script type="text/javascript">
    ...
    $('#type').on('change', function(){
        var isexp = $(this).find("option:selected").attr('data-ise');
        if(isexp==1)
        {
          $('#isexpDiv').removeClass('hidden');
        }
        else
        {
          $('#isexpDiv').addClass('hidden');
        }
    });
    ...
    function edit(id)
    {
        ...
        $.ajax({
            ...
            data: {action : 'ContractorDocumentUpdateData', id: id},
    ...
    function deleterow(id)
    {
        ...
        $.ajax({
            ...
            data: {action : 'ContractorDocumentDeleteData', id: id},

          ...
          <?php include('pages_setting.php'); ?>   
            <div class="card-header" style="background-color: rgb(255 236 230);">
                <div class="d-flex justify-content-between align-items-center">
                    <div class="header">Manage Make</div>

                     <div> 

                        <button type="button" class="btn btn-primary" id="ViewDiv" onclick="ShowHideDiv(this.value);" value="view">Add Make</button>

                        <button type="button" class="btn btn-primary" id="AddDiv" onclick="ShowHideDiv(this.value);" value="add">View Make</button>
            ...
            <div class="card-body" id="AddFormDiv">
                <div class="row">
                  <div class="col-md-12">
                      <form method="post" id="MakeForm" name="MakeForm" action="">
                                ...
                                <div class="row p-t-20">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label class="control-label">Make Description </label>
 ...
 <script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $('#myTable').DataTable({
                    ...
                    'ajax': {
                        ...
                        'data': {
                            'action': 'loadvehiclemaketabledata'
                        }
                    },
                    'columns': [
                        { data: 'name' },
        ...
        $("#MakeForm").validate({
            ...
            submitHandler: function(form) {
                ...
                $.ajax({
                    ...
                    type: "POST", 
                    dataType:"JSON",            
                    data: $("#MakeForm").serialize()+"&action=VehicleMakeform",
                    cache: false,             
                    processData: false,      
    ...
    function edit(id)
    {
        ...
        $.ajax({
            ...
            data: {action : 'VehicleMakeUpdateData', id: id},
    ...
    function deleterow(id)
    {
        ...
        $.ajax({
            ...
            data: {action : 'VehicleMakeDeleteData', id: id},

          ...
          <?php include('pages_setting.php'); ?>   
            <div class="card-header" style="background-color: rgb(255 236 230);">
                <div class="d-flex justify-content-between align-items-center">
                    <div class="header">Manage Onboarding</div>

                     <div> 

                        <button type="button" class="btn btn-primary" id="ViewDiv" onclick="ShowHideDiv(this.value);" value="view">Add Onboarding</button>

                        <button type="button" class="btn btn-primary" id="AddDiv" onclick="ShowHideDiv(this.value);" value="add">View Onboarding</button>
            ...
            <div class="card-body" id="AddFormDiv">
                <div class="row">
                  <div class="col-md-12">
                      <form method="post" id="OnboardingForm" name="OnboardingForm" action="">
 ...
 <script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $('#myTable').DataTable({
                    ...
                    'ajax': {
                        ...
                        'data': {
                            'action': 'loadonboardingtabledata'
                        }
                    },
                    'columns': [
                        { data: 'name' },
            ...
            messages: {
             ...
             submitHandler: function(form) {
                ...
                $.ajax({
                    ...
                    type: "POST", 
                    dataType:"JSON",            
                    data: $("#OnboardingForm").serialize()+"&action=OnboardingForm",
                    cache: false,             
                    processData: false,      
    ...
    function edit(id)
    {
        ...
        $.ajax({
            ...
            data: {action : 'OnboardingUpdateData', id: id},
    ...
    function deleterow(id)
    {
        ...
        $.ajax({
            ...
            data: {action : 'OnboardingDeleteData', id: id},

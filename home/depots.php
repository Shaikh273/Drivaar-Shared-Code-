...
if((isset($_SESSION['permissioncode']) && $_SESSION['permissioncode'][$page_id]==1) || (isset($_SESSION['adt']) && $_SESSION['adt']==1))
{
    ...
    if(isset($_POST['insert']))
    {
        ...
        // string Validation
        $valus[0]['name'] = mysqli_real_escape_string($mysql->dbConnect(), $_POST['name']);
        $valus[0]['userid'] = mysqli_real_escape_string($mysql->dbConnect(),$_POST['userid']);
    ...
    if(isset($_POST['update']))
    {
        ...
        $usercol = array('name','update_date');
        $where = 'id ='. $_POST['id'];
             ...
             <div class="card">    
                <div class="card-header" style="background-color: rgb(255 236 230);">
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="header">Depots (25)</div>
                         <div> 
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="select2 select2-multiple" style="width: 100%" multiple="multiple" name="supervisor[]" id="supervisor"  Placeholder="Select Supervisor">
                                                   ...
                                                   // $strow =  $mysql -> selectFreeRun($statusquery);
                                                    ...
                                                    {
                                                      ?>
                                                     //   <option value="<?// echo $statusresult['id']?>"><?php //echo $statusresult['//name']?></option>
                                                      <?php
                                                    }
                                                   // $mysql -> dbDisconnect();
                                                    ?>
                                        ...
                                        while($roleresult = mysqli_fetch_array($rolerow))
                                        {
                                            ...
                                            <tr>
                                                ...
                                                <td id="<?php echo $roleresult['id']; ?>-td"><?php  
                                                        ...
                                                        {
                                                            ?>
                                                             <button type="button" class="btn btn-success isactivebtn"  onclick="Isactivebtn(<?php echo $roleresult['id']; ?>,<?php echo $roleresult['isactive']; ?>,'Depotisactive');">Active</button></td>
                                                            <?php
                                                        }
                                                        else
                                                        {
 ...
 <script type="text/javascript">
    ...
    function loadpage(did)
    {
        $.ajax({
            ...
            data: {action : 'DepotSetSessionData', did: did},
    ...
    function AddCustomberDatatbl()
    {
      ...
      if(did && customer)
      {
         $.ajax({
                type: "POST",
                url: "InsertData.php",
                data: {action : 'AddWorkforceDepotCustomber', did: did,customer :customer},
                dataType: 'json',
                success: function(data) {
                  if(data.status==1)
                  {
    ...
    function showCustomber(id)
    {
        $.ajax({
            type: "POST",
            url: "loaddata.php",
            data: {action : 'ShowWorkforceDepotCustomber', id: id},
            dataType: 'json',
            success: function(data) {
              if(data.status==1)
              {
    ...
    function deleteworkforcedepotcustomerrow(id,depotid)
    {
        $.ajax({
            ...
            data: {action : 'deleteworkforcedepotcustomer', id: id},
    ...
    function deleterow(id)
    {
        ...
        $.ajax({
            ...
            data: {action : 'DepotDeleteData', id: id},

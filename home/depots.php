...
if ((isset($_SESSION['permissioncode']) && $_SESSION['permissioncode'][$page_id] == 1) || (isset($_SESSION['adt']) && $_SESSION['adt'] == 1)) {
    ...
    if (isset($_POST['insert'])) {
        ...
        // string Validation
        $valus[0]['name'] = test_input($_POST['name']);
        $valus[0]['userid'] = mysqli_real_escape_string($mysql->dbConnect(), $_POST['userid']);


        $check_depot_row = mysqli_fetch_assoc(mysqli_query($mysql->dbConnect(), "select count(*) as total_count from tbl_depot where userid= 'userid' and name='name'"));
        $total_count = $check_depot_row['total_count'];
                                        ...
                                        <div class="form-body">
                                            <div class="row p-t-20">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <label class="control-label">Only <?php echo $depots_left?> left</label>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="select2 select2-multiple" style="width: 100%" multiple="multiple" name="supervisor[]" id="supervisor"  Placeholder="Select Supervisor">
                                                    ...
                                                    {
                                                    ?>
                                                     //   <option value="<? // echo $statusresult['id']

...
include 'DB/config.php';
    ...
    if((isset($_SESSION['permissioncode']) && $_SESSION['permissioncode'][$page_id]==1) || (isset($_SESSION['adt']) && $_SESSION['adt']==1))
    {
        ...
        $mysql = new Mysql();
        $mysql -> dbConnect();
        $query = "SELECT r.*, c.*,m.`name` as modelname,v.`registration_number` as regestrationnumber, s.`name` as suppliername,c.`name` as contaractorname FROM `tbl_vehiclerental_agreement` r
        ...
        INNER JOIN `tbl_vehiclemodel` m ON m.`id`=v.`model_id`
                                    ...
                                    <div class="col-lg-10 container">
                                        <div class="widget-box">
                                            <div class="row widget-header widget-header-large" style="padding-right: 50px;padding-left: 0px;padding-bottom: 15px; margin-left: 0px; margin-right: 0px; padding-top: 10px;">
                                                ...
                                                <div class="col-lg-6">
                                                    <label class="invoice-info-label lable-header">Bryanston Logistics Limited</label><br>
                                                    <label class="text-black">8 SHEPHERDS MARKET, MAYFAIR, W1J 7QE, England</label><br>
                                                    <label class="text-black">Company number 10551950 VAT number 259414193</label><br>
                                                    <span class="blue">Email: mohamed.hassan@bryanstonlogistics.com</span><br>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-8">
                                                            <div class="card-header p-1">
                                                                <label class="a pl-2">Hirer <?php echo $cntresult['contaractorname'];?> Information</label>
                                                            </div> 
                                                            <div class="row mt-2">
                                                                <div class="col-md-6">
                                                                    <div class="row">
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-9">
                                                                            <span><?php echo $cntresult['country'];?></span>
                                                                        </div>
                                                                    </div>
                                                                    <br>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-3">
                                                                            <span class="a">Driver Liacence</span> 
                                                                        </div>
                                                                        <div class="col-md-9">
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-7">
                                                                            <span><?php echo $cntresult['passport_country'];?></span>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                                ...
                                                                <div class="card-body">
                                                                    <div class="row">
                                                                        <div class="col-md-12">
                                                                            ...
                                                                            <span class="text-sm">Class</span><span class="a pl-2"> <?php echo $cntresult['pickup_date'];?></span><br>
                                                        ...
                                                        <div class="col-md-8">
                                                            <div class="card">
                                                                ...
                                                                <div class="card-body">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-6">
                                                                            <span class="pt-1 a">Actual Pickup </span><?php echo date("d M Y", strtotime($cntresult['pickup_date']));?></span>
                                                                        </div>
                                                                        <div class="col-md-6">
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="card">
                                                                ...
                                                                <div class="card-body">
                                                                    <div class="row">
                                                                        <div class="col-md-12">
                                                                            <span class="a">Daily Rate + VAT</span><span> <?php echo $cntresult['daily_rate'] +  $cntresult['daily_rate'];?></span><br>

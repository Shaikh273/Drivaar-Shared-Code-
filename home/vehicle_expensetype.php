          ...
          <?php include('pages_setting.php'); ?>   
            <div class="card-header" style="background-color: rgb(255 236 230);">
                <div class="d-flex justify-content-between align-items-center">
                    <div class="header">Manage Expense Type</div>

                     <div> 

                        <button type="button" class="btn btn-primary" id="ViewDiv" onclick="ShowHideDiv(this.value);" value="view">Add Expense Type</button>

                        <button type="button" class="btn btn-primary" id="AddDiv" onclick="ShowHideDiv(this.value);" value="add">View Expense Type</button>
            ...
            <div class="card-body" id="AddFormDiv">
                <div class="row">
                  <div class="col-md-12">
                      <form method="post" id="ExpenseTypeForm" name="ExpenseTypeForm" action="">
 ...
 <script type="text/javascript">
    $(document).ready(function(){
        ...
        $('#myTable').DataTable({
                    ...
                    'ajax': {
                        ...
                        'data': {
                            'action': 'loadvehicleexpensetypetabledata'
                        }
                    },
                    'columns': [
                        { data: 'name' },
        ...
        $("#ExpenseTypeForm").validate({
            ...
            messages: {
                name: "Please enter your Expense Type",
            },
            submitHandler: function(form) {
                ...
                $.ajax({
                    ...
                    type: "POST", 
                    dataType:"JSON",            
                    data: $("#ExpenseTypeForm").serialize()+"&action=VehicleExpenseTypeForm",
                    cache: false,             
                    processData: false,      
    ...
    function edit(id)
    {
        ...
        $.ajax({
            ...
            data: {action : 'VehicleExpenseTypeUpdateData', id: id},
    ...
    function deleterow(id)
    {
        ...
        $.ajax({
            ...
            data: {action : 'VehicleExpenseTypeDeleteData', id: id},

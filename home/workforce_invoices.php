...
if ((isset($_SESSION['permissioncode']) && $_SESSION['permissioncode'][$page_id] == 1) || (isset($_SESSION['adt']) && $_SESSION['adt'] == 1)) {
  ...
  $query = "SELECT 
                  ...
                  WHERE  i.`depot_id` IN (w.depot_id) AND i.`isdelete`=0 AND i.`isactive`=0 AND i.`istype`=2";
                      ...
                      <!-- 
                                      <div class="col-md-4">
                                        <div class="input-group">
                                              ...
                                              <input type="text" class="form-control" id="searchTable" placeholder="Search for invoices..">
                                        </div>
                                      </div> 
                                    -->
                    </div>
                    ...
                    <!-- <div class="row">
                                    <div class="d-flex mt-3">
                                        ...
                                        <span class="custom-control custom-checkbox">
                                            <label class="custom-control custom-checkbox m-b-0">
                                                <input type="checkbox" class="custom-control-input">
                                                <span class="custom-control-label">Voided</span>
                                            </label>
                                        </span>
                                        ...
                                        <span class="custom-control custom-checkbox">
                                            <label class="custom-control custom-checkbox m-b-0">
                                                <input type="checkbox" class="custom-control-input">
                                                <span class="custom-control-label">Deducted</span>
                                            </label>
                                        </span>
                                        ...
                                        <span class="custom-control custom-checkbox">
                                            <label class="custom-control custom-checkbox m-b-0">
                                                <input type="checkbox" class="custom-control-input">
                                                <span class="custom-control-label">Disputed</span>
                                            </label>
                                        </span>
                                        ...
                                        <span class="custom-control custom-checkbox">
                                            <label class="custom-control custom-checkbox m-b-0">
                                                <input type="checkbox" class="custom-control-input">
                                                <span class="custom-control-label">Overdue</span>
                                            </label>
                                        </span>
                                        ...
                                        <span class="custom-control custom-checkbox">
                                            <label class="custom-control custom-checkbox m-b-0">
                                                <input type="checkbox" class="custom-control-input">
                                                <span class="custom-control-label">Empty Invoices</span>
                                            </label>
                                        </span>
                                    </div> 
                                  </div> -->
                      ...
                      <div class="card-header" style="background-color: rgb(255 236 230);">
                        <div class="d-flex justify-content-between align-items-center">
                          ...
                          <!-- <div class="col-md-2 d-flex align-items-right ">
                            ...
                            <input type="button" class="btn btn-success" value='Export Detail' onclick="loadDetailExporterTable();">
                          </div> -->
                          <div class="btn-group">
                          ...
                          <!-- <div class="btn-group">
                                              ...
                                              <div class="dropdown-menu">
                                                ...
                                                <a class="dropdown-item" href="javascript:void(0)"><i class="fas fa-check">  Approve  </i></a>
                                                <a class="dropdown-item" href="javascript:void(0)"><i class="fas fa-paper-plane"> Send </i></a>
                                                <a class="dropdown-item" href="javascript:void(0)"><i class="fas fa-ban"> Void </i></a>
                                                <a class="dropdown-item" href="javascript:void(0)"><i class="fas fa-file-invoice"> Pay </i></a>
                                              </div>
                                          </div> -->
                          <div class="btn-group">
                            <button type="button" class="btn btn-secondary" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Bulk Action <i class="fa fa-chevron-down"></i>
    ...
    $(document).ready(function() {
      ...
      $('#myTable').DataTable({
        ...
        "ajax": {
          ...
          "type": "POST",
          "data": function(d) {
            d.action = 'loadFinanceWorkforceInvoicestabledata';
            d.did = $('#depot_id').val();
      ...
      if (ths.checked) {
        ...
        if ($("#bulkSelect").is(":checked")) {
          ...
          $.ajax({
            ...
            url: "loaddata.php",
            data: {
              action: 'getworkforceSelectedInvoice',
              search: search,
              did: did,
              statusid: statusid,
              vatid: vatid,
    ...
    function loadExporterTable() {
      if ($("#hidWeek").val()) {
        ...
        $.ajax({
          ...
          url: "loaddata.php",
          data: {
            action: 'exportworkforceInvoiceTableData',
            wikNo: wikNo,
            vat: vat,
            status: status,
            depot_id: depot_id,
    ...
    function loadDetailExporterTable() {
      if ($("#hidWeek").val()) {
        ...
        $.ajax({
          ...
          url: "loaddata.php",
          data: {
            action: 'exportworkforceDetailsInvoiceTableData',
            wikNo: wikNo,
            vat: vat,
            status: status,
            depot_id: depot_id,

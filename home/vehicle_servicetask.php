          ...
          <?php include('pages_setting.php'); ?>   
            <div class="card-header" style="background-color: rgb(255 236 230);">
                <div class="d-flex justify-content-between align-items-center">
                    <div class="header">Manage Service Task</div>

                     <div> 

                        <button type="button" class="btn btn-primary" id="ViewDiv" onclick="ShowHideDiv(this.value);" value="view">Add Service Task</button>

                        <button type="button" class="btn btn-primary" id="AddDiv" onclick="ShowHideDiv(this.value);" value="add">View Service Task</button>
            ...
            <div class="card-body" id="AddFormDiv">
                <div class="row">
                  <div class="col-md-12">
                      <form method="post" id="ServiceTaskForm" name="ServiceTaskForm" action="">
 ...
 <script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $('#myTable').DataTable({
                    ...
                    'ajax': {
                        ...
                        'data': {
                            'action': 'loadvehicleServiceTasktabledata'
                        }
                    },
                    'columns': [
                        { data: 'name' },
        ...
        $("#ServiceTaskForm").validate({
            ...
            messages: {
                name: "Please enter your service task name",
            },
            submitHandler: function(form) {
                ...
                $.ajax({
                    ...
                    type: "POST", 
                    dataType:"JSON",            
                    data: $("#ServiceTaskForm").serialize()+"&action=VehicleServiceTaskForm",
                    cache: false,             
                    processData: false,      
    ...
    function edit(id)
    {
        ...
        $.ajax({
            ...
            data: {action : 'VehicleServiceTaskUpdateData', id: id},
    ...
    function deleterow(id)
    {
        ...
        $.ajax({
            ...
            data: {action : 'VehicleServiceTaskDeleteData', id: id},

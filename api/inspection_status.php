...
$inspection_date=$_POST['ins_date'];
$status=0;
$todaydate =  date('Y-m-d H:i:s');
if(isset($auth_key) && isset($inspection_status) && $inspection_status=='inspection_status' && isset($inspection_date))
{
	...
	echo json_encode(array('status' => $status,'data' => $inspection_status1));
}
?>